...
interface IDeFiOneV1PoolDerivedStateInterface extends ethers.utils.Interface {
  functions: {
...
export class IDeFiOneV1PoolDerivedState extends Contract {
  ...
  interface: IDeFiOneV1PoolDerivedStateInterface;
