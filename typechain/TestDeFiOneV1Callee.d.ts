...
interface TestDeFiOneV1CalleeInterface extends ethers.utils.Interface {
  functions: {
...
export class TestDeFiOneV1Callee extends Contract {
  ...
  interface: TestDeFiOneV1CalleeInterface;
