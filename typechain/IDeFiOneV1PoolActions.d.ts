...
interface IDeFiOneV1PoolActionsInterface extends ethers.utils.Interface {
  functions: {
...
export class IDeFiOneV1PoolActions extends Contract {
  ...
  interface: IDeFiOneV1PoolActionsInterface;
