...
interface IDeFiOneV1PoolImmutablesInterface extends ethers.utils.Interface {
  functions: {
...
export class IDeFiOneV1PoolImmutables extends Contract {
  ...
  interface: IDeFiOneV1PoolImmutablesInterface;
