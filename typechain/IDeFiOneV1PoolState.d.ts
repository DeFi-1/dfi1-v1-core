...
interface IDeFiOneV1PoolStateInterface extends ethers.utils.Interface {
  functions: {
...
export class IDeFiOneV1PoolState extends Contract {
  ...
  interface: IDeFiOneV1PoolStateInterface;
