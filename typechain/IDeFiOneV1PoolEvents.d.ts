...
interface IDeFiOneV1PoolEventsInterface extends ethers.utils.Interface {
  functions: {};
...
export class IDeFiOneV1PoolEvents extends Contract {
  ...
  interface: IDeFiOneV1PoolEventsInterface;
