...
interface MockTimeDeFiOneV1PoolInterface extends ethers.utils.Interface {
  functions: {
...
export class MockTimeDeFiOneV1Pool extends Contract {
  ...
  interface: MockTimeDeFiOneV1PoolInterface;
